...
<?php include "preloader.php"; ?>
    ...
    <body>
    <?php
    //Code TO Show Error At Top Of PAGE
    session_start();
    if(isset($_SESSION['error'])){
        ...
        if(strlen($error)>0){?>
            <div class="alert alert-danger" role="alert">
                ...
                <p><?php echo $error; ?></p>
                <p><a href="./adhaar"><button type="button" class="btn btn-primary">Try Again!</button></a></p>
            </div>
            <?php
        }
    }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="input-group">
                                        <input type="text" class="form-control adh" disabled placeholder="Error"
                                               name="adhaar"
                                               required>
                                        <div class="input-group-append">
                                        <span class="input-group-text">
                                            <i class="fa fa-times-circle animated tada infinite text-danger" data-toggle="popover" title="Warning:"
                                               data-content="Adhaar Card Not Verified! Please Go Back And Fill Again, If wrong data was entered!"
